...
<div class="wrapper">
<!--   <div class="chatintro" id="chatintro">
  	<div class="userInfo" id="userInfo">
        <table border="0" width="70%" align="center" cellpadding="0" style="text-align:center;">
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
          ...
          <tr>
            <td><input type="text" id="username" name="username" class="inputBoxLarge" placeholder="Your Full Name" /></td>
          </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
          <tr>
            <td><input type="button" id="startChat" name="submit" class="btn btn-primary" value="Start Chat!" /> <input type="submit" name="submit" class="btn btn-danger" value="Cancel" /></td>
          </tr>
        </table>
    </div>
  </div> -->
